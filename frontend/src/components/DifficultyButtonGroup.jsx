const DifficultyButtonGroup = ({ selectedButton, onButtonClick }) => {
  return (
    <div className="w-full max-w-xs mt-2 p-2 m-2 grid grid-cols-3 gap-2">
      <button
        className={`py-2 px-2 text-xs rounded-lg ${selectedButton === 'easy' ? 'bg-fuchsia-300 text-white' : 'bg-gray-200'}`}
      ...
      <button
        className={`py-2 px-2 text-xs rounded-lg ${selectedButton === 'normal' ? 'bg-fuchsia-500 text-white' : 'bg-gray-200'}`}
      ...
      <button
        className={`py-2 px-2 text-xs rounded-lg ${selectedButton === 'hard' ? 'bg-fuchsia-600 text-white' : 'bg-gray-200'}`}
